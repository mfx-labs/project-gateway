...
| OD-001 | Exact trusted-local parent-directory convention (e.g., XDG state) | Open, non-blocking | WP-8 implementation phase (phase 2) | At implementation authorization |
